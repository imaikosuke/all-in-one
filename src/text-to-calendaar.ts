...
const calendarEventSchema = {
  ...
  properties: {
    title: {
      type: "string",
      description: "Event title, should be descriptive and very concise",
    },
    start_date: {
      type: "string",
    ...
    start_time: {
      type: "string",
      description: "Start time in hhmmss format",
    },
    end_date: {
      type: "string",
    ...
    end_time: {
      type: "string",
      description: "End time in hhmmss format",
    },
    details: {
      type: "string",
      description:
        "Summary in up to 3 concise sentences. Important URLs must be included and preserved regardless of length.",
    },
    location: {
      type: "string",
  ...
  required: ["title", "start_date", "start_time", "end_date", "end_time", "details", "location"],
};
...

{
  ...
  details: string, // Summary in up to 3 concise sentences. Important URLs must be included and preserved regardless of length
